...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		//	{text: 'Year to date', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
                        {text: 'Last 3 Months', dateStart: function(){ return Date.parse('3 month ago').moveToFirstDayOfMonth();  }, dateEnd:  'today' },
                        {text: 'Last 6 Months', dateStart: function(){ return Date.parse('6 month ago').moveToFirstDayOfMonth();  }, dateEnd:  'today' }
