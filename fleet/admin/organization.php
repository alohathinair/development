...
if ($user->accessLevel < ACCESS_LEVEL_ADMINISTRATOR) {
...
$app->load_component("treeview");
// Add application scripts and styles
$app->set_layout("admin");
$app->set_view("admin/organization");

$app->add_css("/css/master.css");
$app->add_component_js("companyorganization", "manage_organization");
$app->render();
?>